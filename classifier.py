...
class SurnameVectorizer(object):
    ...
    def from_serializable(cls, contents):
        ...
        nationality_vocab = Vocabulary.to_serializable(contents['nationality_vocab'])
...
try:
    for epoch_index in range(args.num_epochs):
        ...
        dataset.set_split('train')
        batch_genetaor = generate_batches(dataset, batch_size=args.batch_size,
                                          device=args.device)
        ...
        for batch_index, batch_dict in enumerate(batch_genetaor):
            optimizer.zero_grad()

            y_pred = classifer(batch_dict['x_surname'])
        ...
        batch_genetaor = generate_batches(dataset, batch_size=args.batch_size, device=args.device)
